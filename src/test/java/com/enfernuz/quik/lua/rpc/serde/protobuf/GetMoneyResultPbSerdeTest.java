...
public class GetMoneyResultPbSerdeTest extends AbstractResultPbSerdeTest<GetMoney.Result, qlua.rpc.GetMoney.Result> {
    ...
    @NotNull
    @Override
    public Class<GetMoney.Result> getTargetObjectClass() {
        return GetMoney.Result.class;
    }
