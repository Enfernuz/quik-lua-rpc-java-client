...
public class PortfolioInfoPbSerdeTest extends AbstractPbSerdeTest<PortfolioInfo, qlua.rpc.GetPortfolioInfo.PortfolioInfo> {
    ...
    @Override
    public @NotNull Class<PortfolioInfo> getTargetObjectClass() {
        return PortfolioInfo.class;
    }

    @NotNull
    @Override
    public GetPortfolioInfo.PortfolioInfo getTargetObjectAsPbMessage() {
        return GetPortfolioInfo.PortfolioInfo.newBuilder()
    ...
    @NotNull
    @Override
    public PortfolioInfo getTargetObject() {
