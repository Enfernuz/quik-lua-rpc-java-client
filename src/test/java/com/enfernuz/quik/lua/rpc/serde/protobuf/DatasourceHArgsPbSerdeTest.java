...
public class DatasourceHArgsPbSerdeTest extends AbstractPbSerializationTest<H.Args, qlua.rpc.datasource.H.Request> {
    ...
    @NotNull
    @Override
    public qlua.rpc.datasource.H.Request getTargetObjectAsPbMessage() {
