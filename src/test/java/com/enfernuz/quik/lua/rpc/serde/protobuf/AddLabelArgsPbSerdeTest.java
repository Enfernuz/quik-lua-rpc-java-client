...
public class AddLabelArgsPbSerdeTest extends AbstractPbSerializationTest<AddLabel.Args, qlua.rpc.AddLabel.Request> {
    ...
    @NotNull
    @Override
    public qlua.rpc.AddLabel.Request getTargetObjectAsPbMessage() {
