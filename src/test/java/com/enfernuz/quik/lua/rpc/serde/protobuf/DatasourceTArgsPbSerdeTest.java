...
public class DatasourceTArgsPbSerdeTest extends AbstractPbSerializationTest<T.Args, qlua.rpc.datasource.T.Request> {
    ...
    @NotNull
    @Override
    public qlua.rpc.datasource.T.Request getTargetObjectAsPbMessage() {

        return qlua.rpc.datasource.T.Request.newBuilder()
