...
public class GetNumberOfArgsPbSerdeTest extends AbstractPbSerializationTest<GetNumberOf.Args, qlua.rpc.GetNumberOf.Request> {
    ...
    @NotNull
    @Override
    public qlua.rpc.GetNumberOf.Request getTargetObjectAsPbMessage() {
