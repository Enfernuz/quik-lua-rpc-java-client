...
public class InsertRowArgsPbSerdeTest extends AbstractPbSerializationTest<InsertRow.Args, qlua.rpc.InsertRow.Request> {
    ...
    @NotNull
    @Override
    public qlua.rpc.InsertRow.Request getTargetObjectAsPbMessage() {
