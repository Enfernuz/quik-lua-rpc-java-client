...
public class GetPortfolioInfoExResultPbSerdeTest extends AbstractResultPbSerdeTest<GetPortfolioInfoEx.Result, qlua.rpc.GetPortfolioInfoEx.Result> {

    @Rule
    public ExpectedException thrown = ExpectedException.none();

    @Override
    public @NotNull Class<GetPortfolioInfoEx.Result> getTargetObjectClass() {
        return GetPortfolioInfoEx.Result.class;
    }
    ...
    @Test
    public void shouldFailOnUninitializedPbPortfolioInfoEx() {

        thrown.expect(SerdeException.class);
        thrown.expectCause(
                allOf(
                        instanceOf(IllegalArgumentException.class),
                        hasProperty("message", equalTo("Экземпляр protobuf-представления qlua.rpc.GetPortfolioInfoEx.Result не содержит поля 'portfolioInfoEx'."))
                )
        );

        getSerdeModuleUnderTest().deserialize(GetPortfolioInfoEx.Result.class, qlua.rpc.GetPortfolioInfoEx.Result.newBuilder().build().toByteArray());
    }
    ...
    public void shouldFailOnUninitializedPbPortfolioInfo() {
        ...
        thrown.expectCause(
                allOf(
                        instanceOf(IllegalArgumentException.class),
                        hasProperty("message", equalTo("Экземпляр protobuf-представления qlua.rpc.GetPortfolioInfoEx.Result не содержит поля 'portfolioInfo' в поле 'portfolioInfoEx'."))
                )
        );

        final qlua.rpc.GetPortfolioInfoEx.PortfolioInfoEx portfolioInfoEx = qlua.rpc.GetPortfolioInfoEx.PortfolioInfoEx.newBuilder().build();
        final qlua.rpc.GetPortfolioInfoEx.Result pbResult = qlua.rpc.GetPortfolioInfoEx.Result.newBuilder()
                .setPortfolioInfoEx(portfolioInfoEx)
                .build();

        getSerdeModuleUnderTest().deserialize(GetPortfolioInfoEx.Result.class, pbResult.toByteArray());
    }
