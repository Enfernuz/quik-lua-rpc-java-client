...
public class DatasourceLArgsPbSerdeTest extends AbstractPbSerializationTest<L.Args, qlua.rpc.datasource.L.Request> {
    ...
    @NotNull
    @Override
    public qlua.rpc.datasource.L.Request getTargetObjectAsPbMessage() {
