...
public class DatasourceCloseArgsPbSerdeTest extends AbstractPbSerializationTest<Close.Args, qlua.rpc.datasource.Close.Request> {
    ...
    @NotNull
    @Override
    public qlua.rpc.datasource.Close.Request getTargetObjectAsPbMessage() {
