...
public class DatasourceVArgsPbSerdeTest extends AbstractPbSerializationTest<V.Args, qlua.rpc.datasource.V.Request> {
    ...
    @NotNull
    @Override
    public qlua.rpc.datasource.V.Request getTargetObjectAsPbMessage() {
