...
public class GetBuySellInfoArgsPbSerdeTest extends AbstractPbSerializationTest<GetBuySellInfo.Args, qlua.rpc.GetBuySellInfo.Request> {
    ...
    @NotNull
    @Override
    public qlua.rpc.GetBuySellInfo.Request getTargetObjectAsPbMessage() {
