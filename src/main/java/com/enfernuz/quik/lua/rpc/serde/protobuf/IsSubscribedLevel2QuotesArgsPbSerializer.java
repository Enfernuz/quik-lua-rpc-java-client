...
enum IsSubscribedLevel2QuotesArgsPbSerializer implements Serializer<IsSubscribedLevel2Quotes.Args>, ToPbConverter<IsSubscribedLevel2Quotes.Args, IsSubscribedLevelIIQuotes.Request> {
    ...
    @Override
    public @NotNull qlua.rpc.IsSubscribedLevelIIQuotes.Request convert(@NotNull final IsSubscribedLevel2Quotes.Args args) {
