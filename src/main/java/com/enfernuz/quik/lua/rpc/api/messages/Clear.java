...
public final class Clear implements RemoteProcedure {

    private Clear() {}

    @EqualsAndHashCode
    public static final class Args implements RpcArgs<Clear> {
    ...
    @Value
    public static class Result implements RpcResult<Clear> {
