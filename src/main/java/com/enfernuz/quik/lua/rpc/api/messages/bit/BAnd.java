...
public final class BAnd implements RemoteProcedure {

    private BAnd() {}

    @JsonPropertyOrder({Args.X_1, Args.X_2, Args.X_I})
    @EqualsAndHashCode
    public static final class Args implements RpcArgs<BAnd> {
    ...
    @Value
    public static class Result implements RpcResult<BAnd> {
