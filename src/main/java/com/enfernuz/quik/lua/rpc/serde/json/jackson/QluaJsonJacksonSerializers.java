...
final class QluaJsonJacksonSerializers extends SimpleSerializers {
    ...
    public QluaJsonJacksonSerializers() {
        ...
        super.addSerializer(GetWorkingFolder.Request.class, new GetWorkingFolderRequestJsonSerializer());
        ...
        super.addSerializer(IsWindowClosed.Request.class, new IsWindowClosedRequestJsonSerializer());
        super.addSerializer(Message.Request.class, new MessageRequestJsonSerializer());
        super.addSerializer(ParamRequest.Request.class, new ParamRequestRequestJsonSerializer());
        super.addSerializer(PrintDbgStr.Request.class, new PrintDbgStrRequestJsonSerializer());
        super.addSerializer(RGB.Request.class, new RGBRequestJsonSerializer());
        super.addSerializer(SearchItems.Request.class, new SearchItemsRequestJsonSerializer());
        super.addSerializer(SendTransaction.Request.class, new SendTransactionRequestJsonSerializer());
        super.addSerializer(SetCell.Request.class, new SetCellRequestJsonSerializer());
        super.addSerializer(SetColor.Request.class, new SetColorRequestJsonSerializer());
        ...
        super.addSerializer(UnsubscribeLevel2Quotes.Request.class, new UnsubscribeLevel2QuotesRequestJsonSerializer());
        super.addSerializer(BAnd.Request.class, new BitBAndRequestJsonSerializer());
        ...
        super.addSerializer(SysDate.Request.class, new SysDateRequestJsonSerializer());
        super.addSerializer(CreateDataSource.Request.class, new DatasourceCreateDatasourceRequestJsonSerializer());
        super.addSerializer(O.Request.class, new DatasourceORequestJsonSerializer());
        ...
        super.addSerializer(V.Request.class, new DatasourceVRequestJsonSerializer());
        super.addSerializer(Close.Request.class, new DatasourceCloseRequestJsonSerializer());
        ...
        super.addSerializer(GetParamEx.Request.class, new GetParamExRequestJsonSerializer());
        super.addSerializer(GetParamEx2.Request.class, new GetParamEx2RequestJsonSerializer());
    }
}
