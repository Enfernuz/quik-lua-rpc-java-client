...
public final class SubscribeLevel2Quotes implements RemoteProcedure {

    private SubscribeLevel2Quotes() {}

    @JsonPropertyOrder({Args.CLASS_CODE, Args.SEC_CODE})
    @EqualsAndHashCode
    public static final class Args implements RpcArgs<SubscribeLevel2Quotes> {
    ...
    @Value
    public static class Result implements RpcResult<SubscribeLevel2Quotes> {
