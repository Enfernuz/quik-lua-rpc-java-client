...
enum DsSizePbArgsSerializer implements Serializer<Size.Args>, ToPbConverter<Size.Args, qlua.rpc.datasource.Size.Request> {
    ...
    @NotNull
    @Override
    public qlua.rpc.datasource.Size.Request convert(@NotNull final Size.Args args) {
