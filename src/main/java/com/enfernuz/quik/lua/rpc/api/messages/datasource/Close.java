...
public final class Close implements RemoteProcedure {

    private Close() {}

    @EqualsAndHashCode
    public static final class Args implements RpcArgs<Close> {
    ...
    @Value
    public static class Result implements RpcResult<Close> {
