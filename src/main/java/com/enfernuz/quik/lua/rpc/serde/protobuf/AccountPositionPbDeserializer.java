...
enum AccountPositionPbDeserializer implements Deserializer<AccountPosition> {
    ...
    public AccountPosition deserialize(final byte[] data) {
        ...
        final QluaStructures.AccountPosition accountPosition = QluaStructures.AccountPosition.parseFrom(data);
