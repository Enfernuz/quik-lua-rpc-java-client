...
public final class UnsubscribeLevel2Quotes implements RemoteProcedure {

    private UnsubscribeLevel2Quotes() {}

    @JsonPropertyOrder({Args.CLASS_CODE, Args.SEC_CODE})
    @EqualsAndHashCode
    public static final class Args implements RpcArgs<UnsubscribeLevel2Quotes> {
    ...
    @Value
    public static class Result implements RpcResult<UnsubscribeLevel2Quotes> {
